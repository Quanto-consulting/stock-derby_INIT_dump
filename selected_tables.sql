...
--
-- Name: admin; Type: TABLE; Schema: public; Owner: node_app
--
...
CREATE TABLE public.admin (
    ...
    role public.admin_role_enum DEFAULT 'company_admin'::public.admin_role_enum NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone,
    "cachedPassword" character varying,
    "companyId" integer
);


ALTER TABLE public.admin OWNER TO node_app;

--
-- Name: admin_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--
...
ALTER SEQUENCE public.admin_id_seq OWNER TO node_app;

--
-- Name: admin_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--
...
--
-- Name: coin_toss_pair; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.coin_toss_pair (
    id integer NOT NULL,
    type public.coin_toss_pair_type_enum NOT NULL,
...
ALTER TABLE public.coin_toss_pair OWNER TO node_app;

--
-- Name: coin_toss_pair_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.coin_toss_pair_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.coin_toss_pair_id_seq OWNER TO node_app;

--
-- Name: coin_toss_pair_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.coin_toss_pair_id_seq OWNED BY public.coin_toss_pair.id;


--
-- Name: company; Type: TABLE; Schema: public; Owner: node_app
--
...
CREATE TABLE public.company (
    ...
    "contactPersonEmail" character varying NOT NULL,
    logo character varying NOT NULL,
    domain character varying NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone,
    "paymentImage" character varying DEFAULT 'https://via.placeholder.com/150'::character varying NOT NULL,
    "placementNotAllowed" public.company_placementnotallowed_enum[] DEFAULT '{}'::public.company_placementnotallowed_enum[] NOT NULL,
    "depositBonusPercentage" integer DEFAULT 0 NOT NULL,
    "depositBonusPercentageEnabled" boolean DEFAULT true NOT NULL,
    theme jsonb DEFAULT '{"primary": "#0A1634", "secondary": "#122148"}'::jsonb NOT NULL,
    "externalPayIn" boolean DEFAULT false NOT NULL,
    "externalPayOut" boolean DEFAULT false NOT NULL,
    "otpIntegration" boolean DEFAULT false NOT NULL,
    "minPlacement" integer DEFAULT 0 NOT NULL,
    "maxPlacement" integer DEFAULT 10000 NOT NULL,
    "coinValues" integer[] DEFAULT '{100,500,1000,2000}'::integer[],
    "stockProfitLossPercentage" integer DEFAULT 7 NOT NULL,
    "casinoProfitLossPercentage" integer DEFAULT 3 NOT NULL,
    "minCasinoPlacement" integer DEFAULT 0 NOT NULL,
    "maxCasinoPlacement" integer DEFAULT 10000 NOT NULL,
    "cryptoPayIn" boolean DEFAULT false NOT NULL,
    "cryptoPayOut" boolean DEFAULT false NOT NULL,
    "allowedCasino" boolean DEFAULT false NOT NULL,
    "maxSinglePlacementPerGameType" jsonb DEFAULT '{"dice": 1000, "derby": 1000, "lobby": 2000, "aviator": 2000, "head_tail": 2000, "red_black": 2000, "stock_slots": 2000, "seven_up_down": 2000, "stock_jackpot": 2000, "guess_last_four": 2000, "guess_first_four": 2000, "guess_last_eight": 2000, "mini_mutual_fund": 2000, "wheel_of_fortune": 2000, "guess_first_eight": 2000}'::jsonb,
    "gameRestrictions" public.company_gamerestrictions_enum[] DEFAULT '{}'::public.company_gamerestrictions_enum[] NOT NULL,
    "dynamicQR" boolean DEFAULT false NOT NULL,
    "userVerfication" boolean DEFAULT false NOT NULL,
    "askWithdrawlOption" boolean DEFAULT false NOT NULL
);


ALTER TABLE public.company OWNER TO node_app;

--
-- Name: company_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--
...
ALTER SEQUENCE public.company_id_seq OWNER TO node_app;

--
-- Name: company_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--
...
--
-- Name: company_qr; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.company_qr (
    id integer NOT NULL,
    qr character varying,
    type character varying DEFAULT 'upi'::character varying NOT NULL,
    "bankName" character varying,
    "accountNumber" character varying,
    "ifscCode" character varying,
    "maxLimit" integer NOT NULL,
    "limitUsed" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE public.company_qr OWNER TO node_app;

--
-- Name: company_qr_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.company_qr_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.company_qr_id_seq OWNER TO node_app;

--
-- Name: company_qr_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.company_qr_id_seq OWNED BY public.company_qr.id;


--
-- Name: company_wallet; Type: TABLE; Schema: public; Owner: node_app
--
...
ALTER TABLE public.company_wallet OWNER TO node_app;

--
-- Name: company_wallet_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.company_wallet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.company_wallet_id_seq OWNER TO node_app;

--
-- Name: company_wallet_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.company_wallet_id_seq OWNED BY public.company_wallet.id;


--
-- Name: jackpot_pair; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.jackpot_pair (
    id integer NOT NULL,
    type public.jackpot_pair_type_enum NOT NULL,
    active boolean DEFAULT true NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone
...
ALTER TABLE public.jackpot_pair OWNER TO node_app;

--
-- Name: jackpot_pair_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.jackpot_pair_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.jackpot_pair_id_seq OWNER TO node_app;

--
-- Name: jackpot_pair_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.jackpot_pair_id_seq OWNED BY public.jackpot_pair.id;


--
-- Name: jackpot_pair_market_items_market_item; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.jackpot_pair_market_items_market_item (
    "jackpotPairId" integer NOT NULL,
    "marketItemId" integer NOT NULL
);


ALTER TABLE public.jackpot_pair_market_items_market_item OWNER TO node_app;

--
-- Name: market_item; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.market_item (
    id integer NOT NULL,
    type public.market_item_type_enum NOT NULL,
    active boolean DEFAULT false NOT NULL,
    name character varying NOT NULL,
    "oddsMultiplier" integer NOT NULL,
    code character varying NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone,
    "placementAllowed" boolean DEFAULT true NOT NULL,
    "horseNumber" integer NOT NULL,
    "isFixed" boolean DEFAULT false NOT NULL,
    "allowedStockSlot" boolean DEFAULT true NOT NULL,
    "allowedJackpot" boolean DEFAULT true NOT NULL
);


ALTER TABLE public.market_item OWNER TO node_app;

--
-- Name: market_item_horseNumber_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public."market_item_horseNumber_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."market_item_horseNumber_seq" OWNER TO node_app;

--
-- Name: market_item_horseNumber_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public."market_item_horseNumber_seq" OWNED BY public.market_item."horseNumber";


--
-- Name: market_item_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.market_item_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.market_item_id_seq OWNER TO node_app;

--
-- Name: market_item_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.market_item_id_seq OWNED BY public.market_item.id;


--
-- Name: scheduler; Type: TABLE; Schema: public; Owner: node_app
--
...
CREATE TABLE public.scheduler (
    ...
    type public.scheduler_type_enum NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone,
    "companyId" integer NOT NULL,
    "createRound" boolean DEFAULT true NOT NULL
);


ALTER TABLE public.scheduler OWNER TO node_app;

--
-- Name: scheduler_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--
...
ALTER SEQUENCE public.scheduler_id_seq OWNER TO node_app;

--
-- Name: scheduler_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--
...
--
-- Name: seven_up_down_pair; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.seven_up_down_pair (
    id integer NOT NULL,
    type public.seven_up_down_pair_type_enum NOT NULL,
    active boolean DEFAULT true NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone
...
ALTER TABLE public.seven_up_down_pair OWNER TO node_app;

--
-- Name: seven_up_down_pair_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.seven_up_down_pair_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.seven_up_down_pair_id_seq OWNER TO node_app;

--
-- Name: seven_up_down_pair_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.seven_up_down_pair_id_seq OWNED BY public.seven_up_down_pair.id;


--
-- Name: seven_up_down_pair_market_items_market_item; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.seven_up_down_pair_market_items_market_item (
    "sevenUpDownPairId" integer NOT NULL,
    "marketItemId" integer NOT NULL
);


ALTER TABLE public.seven_up_down_pair_market_items_market_item OWNER TO node_app;

--
-- Name: slot_pair_market_items_market_item; Type: TABLE; Schema: public; Owner: node_app
--

CREATE TABLE public.slot_pair_market_items_market_item (
    "slotPairId" integer NOT NULL,
    "marketItemId" integer NOT NULL
);


ALTER TABLE public.slot_pair_market_items_market_item OWNER TO node_app;

--
-- Name: tier_list; Type: TABLE; Schema: public; Owner: node_app
--
...
CREATE TABLE public.tier_list (
    ...
    "gamesRequired" integer DEFAULT 0 NOT NULL,
    "loginPoints" integer DEFAULT 0 NOT NULL,
    "firstGamePoints" integer DEFAULT 0 NOT NULL,
    "pointsPerHundredRupees" numeric(10,2) NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp without time zone,
    "companyId" integer,
    "weeklyWithdrawLimit" integer DEFAULT 0 NOT NULL,
    "dailyWithdrawLimit" integer DEFAULT 0 NOT NULL,
    "monthlyWithdrawLimit" integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.tier_list OWNER TO node_app;

--
-- Name: tier_list_id_seq; Type: SEQUENCE; Schema: public; Owner: node_app
--

CREATE SEQUENCE public.tier_list_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tier_list_id_seq OWNER TO node_app;

--
-- Name: tier_list_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: node_app
--

ALTER SEQUENCE public.tier_list_id_seq OWNED BY public.tier_list.id;


--
-- Name: admin id; Type: DEFAULT; Schema: public; Owner: node_app
--
...
--
-- Name: coin_toss_pair id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.coin_toss_pair ALTER COLUMN id SET DEFAULT nextval('public.coin_toss_pair_id_seq'::regclass);


--
-- Name: company id; Type: DEFAULT; Schema: public; Owner: node_app
--
...
--
-- Name: company_qr id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_qr ALTER COLUMN id SET DEFAULT nextval('public.company_qr_id_seq'::regclass);


--
-- Name: company_wallet id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_wallet ALTER COLUMN id SET DEFAULT nextval('public.company_wallet_id_seq'::regclass);


--
-- Name: jackpot_pair id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.jackpot_pair ALTER COLUMN id SET DEFAULT nextval('public.jackpot_pair_id_seq'::regclass);


--
-- Name: market_item id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.market_item ALTER COLUMN id SET DEFAULT nextval('public.market_item_id_seq'::regclass);


--
-- Name: market_item horseNumber; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.market_item ALTER COLUMN "horseNumber" SET DEFAULT nextval('public."market_item_horseNumber_seq"'::regclass);


--
-- Name: scheduler id; Type: DEFAULT; Schema: public; Owner: node_app
--
...
--
-- Name: seven_up_down_pair id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.seven_up_down_pair ALTER COLUMN id SET DEFAULT nextval('public.seven_up_down_pair_id_seq'::regclass);


--
-- Name: tier_list id; Type: DEFAULT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.tier_list ALTER COLUMN id SET DEFAULT nextval('public.tier_list_id_seq'::regclass);
...
--
-- Name: company PK_056f7854a7afdba7cbd6d45fc20; Type: CONSTRAINT; Schema: public; Owner: node_app
--
...
--
-- Name: company_wallet PK_4a6194b005c383df6539faa3f3e; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_wallet
    ADD CONSTRAINT "PK_4a6194b005c383df6539faa3f3e" PRIMARY KEY (id);


--
-- Name: seven_up_down_pair PK_578aa6c1651bc4e89d966169490; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.seven_up_down_pair
    ADD CONSTRAINT "PK_578aa6c1651bc4e89d966169490" PRIMARY KEY (id);


--
-- Name: company_qr PK_671e4370b79da13cb99645c048e; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_qr
    ADD CONSTRAINT "PK_671e4370b79da13cb99645c048e" PRIMARY KEY (id);


--
-- Name: slot_pair_market_items_market_item PK_b91290fd7f48350e7d783d7afb2; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.slot_pair_market_items_market_item
    ADD CONSTRAINT "PK_b91290fd7f48350e7d783d7afb2" PRIMARY KEY ("slotPairId", "marketItemId");


--
-- Name: scheduler PK_c11a0f76186d81647aeefd54c72; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.scheduler
    ADD CONSTRAINT "PK_c11a0f76186d81647aeefd54c72" PRIMARY KEY (id);


--
-- Name: coin_toss_pair PK_cb3be9bd8028ee267bbb16a0b1a; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.coin_toss_pair
    ADD CONSTRAINT "PK_cb3be9bd8028ee267bbb16a0b1a" PRIMARY KEY (id);


--
-- Name: seven_up_down_pair_market_items_market_item PK_d5172c2b373e8daa674fc65b527; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.seven_up_down_pair_market_items_market_item
    ADD CONSTRAINT "PK_d5172c2b373e8daa674fc65b527" PRIMARY KEY ("sevenUpDownPairId", "marketItemId");


--
-- Name: tier_list PK_d6a57d86fd942216817200f8574; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.tier_list
    ADD CONSTRAINT "PK_d6a57d86fd942216817200f8574" PRIMARY KEY (id);


--
-- Name: admin PK_e032310bcef831fb83101899b10; Type: CONSTRAINT; Schema: public; Owner: node_app
--
...
--
-- Name: jackpot_pair PK_e7b7a2f1c65e07e64c062ee6131; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.jackpot_pair
    ADD CONSTRAINT "PK_e7b7a2f1c65e07e64c062ee6131" PRIMARY KEY (id);


--
-- Name: jackpot_pair_market_items_market_item PK_fb6cfd1510364facc21b847b357; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.jackpot_pair_market_items_market_item
    ADD CONSTRAINT "PK_fb6cfd1510364facc21b847b357" PRIMARY KEY ("jackpotPairId", "marketItemId");


--
-- Name: market_item PK_fc9f91dbb8a0d0675d00d292471; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.market_item
    ADD CONSTRAINT "PK_fc9f91dbb8a0d0675d00d292471" PRIMARY KEY (id);


--
-- Name: company_wallet REL_86851fc58f78f271aca4b6ac55; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_wallet
    ADD CONSTRAINT "REL_86851fc58f78f271aca4b6ac55" UNIQUE (company_id);


--
-- Name: tier_list UQ_07e3300acf2bdd557d25ee54804; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.tier_list
    ADD CONSTRAINT "UQ_07e3300acf2bdd557d25ee54804" UNIQUE (name, "companyId");


--
-- Name: scheduler UQ_7b4ac191b949772d3c91994db17; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.scheduler
    ADD CONSTRAINT "UQ_7b4ac191b949772d3c91994db17" UNIQUE ("companyId", "endDate", type);


--
-- Name: scheduler UQ_7bec2115666b50ba076b2989e2d; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.scheduler
    ADD CONSTRAINT "UQ_7bec2115666b50ba076b2989e2d" UNIQUE ("companyId", "startDate", type);


--
-- Name: market_item UQ_b28249a27b39e085cf2273508db; Type: CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.market_item
    ADD CONSTRAINT "UQ_b28249a27b39e085cf2273508db" UNIQUE (code);


--
-- Name: admin UQ_de87485f6489f5d0995f5841952; Type: CONSTRAINT; Schema: public; Owner: node_app
--
...
--
-- Name: IDX_20617d2ae2208664ea74528228; Type: INDEX; Schema: public; Owner: node_app
--

CREATE INDEX "IDX_20617d2ae2208664ea74528228" ON public.seven_up_down_pair_market_items_market_item USING btree ("marketItemId");


--
-- Name: IDX_2ac44fa5ae108140cc9fae5ead; Type: INDEX; Schema: public; Owner: node_app
--

CREATE INDEX "IDX_2ac44fa5ae108140cc9fae5ead" ON public.slot_pair_market_items_market_item USING btree ("slotPairId");


--
-- Name: IDX_4b2b28b58362574847a0fe5a96; Type: INDEX; Schema: public; Owner: node_app
--

CREATE INDEX "IDX_4b2b28b58362574847a0fe5a96" ON public.seven_up_down_pair_market_items_market_item USING btree ("sevenUpDownPairId");


--
-- Name: IDX_80d1ec281254c5b1a84bd750a3; Type: INDEX; Schema: public; Owner: node_app
--

CREATE INDEX "IDX_80d1ec281254c5b1a84bd750a3" ON public.jackpot_pair_market_items_market_item USING btree ("marketItemId");


--
-- Name: IDX_e24ced82194ca48ae6a229512c; Type: INDEX; Schema: public; Owner: node_app
--

CREATE INDEX "IDX_e24ced82194ca48ae6a229512c" ON public.jackpot_pair_market_items_market_item USING btree ("jackpotPairId");


--
-- Name: IDX_f3eaceef1b4250baffd91c0b09; Type: INDEX; Schema: public; Owner: node_app
--

CREATE INDEX "IDX_f3eaceef1b4250baffd91c0b09" ON public.slot_pair_market_items_market_item USING btree ("marketItemId");


--
-- Name: seven_up_down_pair_market_items_market_item FK_20617d2ae2208664ea74528228a; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.seven_up_down_pair_market_items_market_item
    ADD CONSTRAINT "FK_20617d2ae2208664ea74528228a" FOREIGN KEY ("marketItemId") REFERENCES public.market_item(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: slot_pair_market_items_market_item FK_2ac44fa5ae108140cc9fae5eade; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.slot_pair_market_items_market_item
    ADD CONSTRAINT "FK_2ac44fa5ae108140cc9fae5eade" FOREIGN KEY ("slotPairId") REFERENCES public.slot_pair(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: coin_toss_pair FK_3a7c64aff44710ee3bc6c327ba9; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.coin_toss_pair
    ADD CONSTRAINT "FK_3a7c64aff44710ee3bc6c327ba9" FOREIGN KEY ("tailId") REFERENCES public.market_item(id);


--
-- Name: seven_up_down_pair_market_items_market_item FK_4b2b28b58362574847a0fe5a962; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.seven_up_down_pair_market_items_market_item
    ADD CONSTRAINT "FK_4b2b28b58362574847a0fe5a962" FOREIGN KEY ("sevenUpDownPairId") REFERENCES public.seven_up_down_pair(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: jackpot_pair_market_items_market_item FK_80d1ec281254c5b1a84bd750a3d; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.jackpot_pair_market_items_market_item
    ADD CONSTRAINT "FK_80d1ec281254c5b1a84bd750a3d" FOREIGN KEY ("marketItemId") REFERENCES public.market_item(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: company_wallet FK_86851fc58f78f271aca4b6ac55d; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_wallet
    ADD CONSTRAINT "FK_86851fc58f78f271aca4b6ac55d" FOREIGN KEY (company_id) REFERENCES public.company(id);


--
-- Name: coin_toss_pair FK_8fb6434421329d1127bbca3a26f; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.coin_toss_pair
    ADD CONSTRAINT "FK_8fb6434421329d1127bbca3a26f" FOREIGN KEY ("headId") REFERENCES public.market_item(id);


--
-- Name: tier_list FK_b80e38b7ed5eca313f597ee196e; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.tier_list
    ADD CONSTRAINT "FK_b80e38b7ed5eca313f597ee196e" FOREIGN KEY ("companyId") REFERENCES public.company(id);


--
-- Name: admin FK_b8e6195892b14d4c6a4c997b4cb; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.admin
    ADD CONSTRAINT "FK_b8e6195892b14d4c6a4c997b4cb" FOREIGN KEY ("companyId") REFERENCES public.company(id);


--
-- Name: jackpot_pair_market_items_market_item FK_e24ced82194ca48ae6a229512c9; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.jackpot_pair_market_items_market_item
    ADD CONSTRAINT "FK_e24ced82194ca48ae6a229512c9" FOREIGN KEY ("jackpotPairId") REFERENCES public.jackpot_pair(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: company_qr FK_e97569d261c59715e32ccd306bf; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.company_qr
    ADD CONSTRAINT "FK_e97569d261c59715e32ccd306bf" FOREIGN KEY ("companyId") REFERENCES public.company(id);


--
-- Name: slot_pair_market_items_market_item FK_f3eaceef1b4250baffd91c0b096; Type: FK CONSTRAINT; Schema: public; Owner: node_app
--

ALTER TABLE ONLY public.slot_pair_market_items_market_item
    ADD CONSTRAINT "FK_f3eaceef1b4250baffd91c0b096" FOREIGN KEY ("marketItemId") REFERENCES public.market_item(id) ON UPDATE CASCADE ON DELETE CASCADE;
